  ...
  return (
    <html lang="en">
      ...
      <body className={`${inter.className}`}>
        ...
        <Toaster />
        <main className="w-dvw min-h-dvh h-auto md:h-[calc(100dvh-40px)] mx-auto md:w-[552px] md:border md:border-black-20 md:rounded-t-[20px] md:overflow-auto md:no-scrollbar bg-white">
